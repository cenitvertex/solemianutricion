        ...
        <div style={{
            ...
            <div className="card glass animate-scale-in auth-card" style={{
                ...
                <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    {error && (
                        <div className="animate-premium" style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#fff1f2', borderRadius: '1rem', border: '1px solid rgba(225, 29, 72, 0.15)', overflow: 'hidden', marginTop: '1rem', flexShrink: 0 }}>
