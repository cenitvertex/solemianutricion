        ...
        <div className="layout-dashboard animate-premium">
            ...
            {isDeleteModalOpen && (
                <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(142,45,79,0.5)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 120, padding: '1rem' }}>
                    <div className="card animate-scale-in" style={{ maxWidth: '400px', width: '100%', textAlign: 'center', padding: '2rem', borderRadius: '2.5rem' }}>
                        <div style={{ backgroundColor: '#fff5f5', color: '#e53e3e', padding: '1rem', borderRadius: '50%', width: 'fit-content', margin: '0 auto 1.5rem' }}>
                            <Trash2 size={32} />
                        </div>
                        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', color: 'var(--solemia-plum)', fontWeight: '900' }}>¿Eliminar Paciente?</h3>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                            <button onClick={deletePatient} className="btn" style={{ backgroundColor: '#e53e3e', color: 'white', width: '100%', borderRadius: '1rem', padding: '1rem' }}>Sí, eliminar</button>
                            <button onClick={() => { setIsDeleteModalOpen(false); setPatientToDelete(null); }} className="btn btn-outline" style={{ width: '100%', borderRadius: '1rem', padding: '1rem' }}>Cancelar</button>
                        </div>
                    </div>
                </div>
            )}
